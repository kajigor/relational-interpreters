...
let eval graph numbering r =
     let rec eval graph numbering n r =
         ((graph === (nil ())) &&& (r === (!! true))) |||
            (fresh (b e graph') (graph === ((pair b e) % graph'))
               (fresh (q47 nb ne) (lookup numbering b nb) (lookup numbering e ne) (less nb ne q47)
                  (conde
                     [(q47 === (!! false)) &&& (r === (!! false));
                     fresh (q43) (q47 === (!! true)) (less ne n q43)
                       (conde [(q43 === (!! false)) &&& (r === (!! false)); (q43 === (!! true)) &&& (eval graph' numbering n r)])]))) in
     (fresh (n n') (n' === (s n)) (numberOfnodes graph n) (eval graph numbering n' r))
